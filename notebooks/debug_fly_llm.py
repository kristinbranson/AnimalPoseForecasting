...
os.path.relpath(test_train_path, test_dir)

# +
from flyllm.io import json_load_helper

config_file = "/groups/branson/home/eyjolfsdottire/code/MABe2022/config_fly_llm_multitimeglob_discrete_20230907.json"
config = json_load_helper(config_file)
config
...
test_train_path = os.path.join(pardir, 'small_intrainfile.npz')
...
test_val_path = os.path.join(pardir, 'small_invalfile.npz')
